...
const Main1= ({reverse,value2,change1,value3,value4,value5,value6,value7,value10,value11,changetodoge,changetoltc,changetobtc,changetodoge4,changetoltc4,changetobtc4,event1,value500,from1,to1,value71,value72,value73,value74,value75,value76,call,value1500,value1006,backtohome,changetoxmr,value738,changetoxmr2,value739,value740,value741,changetobnb1,changetobnb2,value750,value751,changetobch1,changetobch2,changetotrx1,value760,value761,value7610,value501,value10070,value1600,changetorose1,event105,changetorose2,changetodash1,send2,first56,first66,changetoavax1,changetoada1,changetovet1,changetoxtz1,value81,changetoeth1,value859,changetosol1,theme,value8591,changetoetc1,changetodark,value1008,value10091,value10092,bg1,value10081,value10082,value10083,changetolight,value10085,logo_value,value10087,value10088,value100910,value10059,value100912,value10057})=>{
    ...
    return(
        ...
        <Col className='col-md-3 d-flex justify-content-center align-items-center flex-row' > <a className="btn45 mt-1 me-2 f6 grow no-underline ba bw1 ph2 pv1 mb1 dib b text-white pt-1">搜索</a>
        <input id="name" placeholder='您的订单号' className="b input-reset ba b--black-20 pt-2 pb-2 ps-2 db w-60" type="text" aria-describedby="name-desc" /> </Col>
        ...
        <Navbar bg={theme} expand="lg" className='navbar1'>
                    <Container>
                        ...
                        <Nav.Link href="#home" style={{'color':`${value1008}`}} className='d-flex justify-content-center align-items-center navlink'>钱包 <img src={require(`${value10091}`)}   className='ms-2' width={'17px'}/>
                        <span className="b span45 d-flex justify-content-center align-items-center" style={{'color':`${value10092}`}}>工作</span>
                        </Nav.Link>
                        <Nav.Link href="#home" style={{'color':`${value1008}`}} className='d-flex justify-content-center align-items-center navlink'>系统状态  <img src={require(`${value10091}`)} className='ms-2' width={'17px'}/>
                        <span className="b span45 d-flex justify-content-center align-items-center" style={{'color':`${value10092}`}} >工作</span></Nav.Link>
                            ...
                            <Dropdown.Item style={{'color':`${value10059}`}} href="https://hi.bitbarter.org">हिंदी    <img src={require(`./india.jpg`)} className='flag1' width='30px' /> </Dropdown.Item>
                            <Dropdown.Item style={{'color':`${value10059}`}} href="https://jp.bitbarter.org">日本語 <img src={require(`./japan.png`)} className='flag2' width='30px' /> </Dropdown.Item>
                            <Dropdown.Item style={{'color':`${value10059}`}} href="https://cn.bitbarter.org">中文 <img src={require(`./china.png`)} className='flag3' width='30px' /> </Dropdown.Item>
                            <Dropdown.Item style={{'color':`${value10059}`}} href="https://ru.bitbarter.org">руский <img src={require(`./russia.png`)} className='flag4' width='30px' /> </Dropdown.Item>
                            <Dropdown.Item style={{'color':`${value10059}`}} href="https://bitbarter.org">English <img className='flag5' src={require(`./en.png`)} width='30px' /> </Dropdown.Item>
                            </Dropdown.Menu>
            ...
            <article className="mw7 center br3 pa3 pa4-ns mv3 ba b--black-10 shadow-3" style={{'background-color':`${value100910}`,'border':`${value10057}`}} onClick={() => {
				...
				setLgShow2('SEND')
                    ...
                    <h3 className='b send_r mt-4 mb-1' style={{'color':`${value10059}`}} >您已发送</h3>
                ...
                <h3 className='b send_r mt-4 mb-1' style={{'color':`${value10059}`}} >你收到</h3>
            ...
            <Row className='mt-3'>
            <Col className='col-md-12 text-black'>
            <p className='b para258' style={{'color':`${value10059}`}}>输入您将发送的金额</p>
            ...
            <p className='b text-red text-center tc para3000' style={{'display':`${value1600}`}} >请输入金额</p>
            </Col>
            </Row>
            
            <Row className='mt-3'>
            <Col className='col-md-12 text-black'>
            <p style={{'color':`${value10059}`}} className='b para10'>收货地址</p>
                </Col>
            </Row>
            ...
            <Row className='mt-3'>
                <Col className='col-md-12 text-black'>
                <Button className='btn2 b shadow-3' style={{'background-color':`${value100910}`,'border':`${value10057}`,'color':`${value10059}`}}  onClick={call}>交换</Button>
                </Col>
            </Row>
      ...
      <h3 className='b tc text-black'>YOU {lgShow2} </h3>
        ...
        <Modal.Body >
            ...
            <h2 className='tc b mt-4 text-center'>如何交换加密</h2>
            <p className='tc text-cente br'>在 Bitbarter上交换加密非常简单。</p>
            <p className='tc text-center'>遵循四个步骤</p>
            ...
            <path d="M 8.75 14 v -3 v -0.967 H 8.75 v -1.31 h 2.445 v -0.967 H 9.128 L 12.5 2 h -1.699 L 8.047 7.327 h -0.086 L 5.207 2 H 3.5 l 3.363 6.127 H 4.778 v 0.968 H 7.25 v 1.31 v 0.966 V 14 h 1.502 z"/>
            </svg>
            <h6>在几秒钟内收到您的加密货币</h6>
            </Col>
            </Row>
